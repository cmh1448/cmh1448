...
소프트웨어 설계와 협업 가능한 코드에 관심이 있는 <br />
백엔드 개발자 천명현 입니다.

## 🔧 Tech Stack
[![My Skills](https://skillicons.dev/icons?i=java,spring,docker,kafka,kubernetes)](https://skillicons.dev)

## 📌 Featured Projects
- [Auto-Jwt](https://github.com/cmh1448/AutoJwt) - 간편한 Jwt인증 구현 라이브러리
- [Learnit](https://github.com/DEPthes/4th-MVP-LearningCrew-Server) - 온라인 그룹스터디 플랫폼
